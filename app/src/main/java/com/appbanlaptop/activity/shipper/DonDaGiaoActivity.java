...
public class DonDaGiaoActivity extends AppCompatActivity {

    RecyclerView recyclerViewOrderShipper;
    OrderAdapterShipperDaGiao orderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_don_da_giao);
    ...
    private void initView(){
        recyclerViewOrderShipper = findViewById(R.id.recycle_order_shipper_da_giao);
    ...
    public void getListUsers() {
        Call<OrderModel> call = apiShopLapTop.getDonDaGiao(Utils.user_id);
        call.enqueue(new Callback<OrderModel>() {
            ...
            public void onResponse(Call<OrderModel> call, Response<OrderModel> response) {
                ...
                if (orderModel.isSuccess()) {
                    ...
                    orderAdapter = new OrderAdapterShipperDaGiao(orderList,DonDaGiaoActivity.this);
