...
public class DonDaXacNhanActivity extends AppCompatActivity {

    RecyclerView recyclerViewOrderShipper;
    OrderAdapterShipper orderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_don_da_xac_nhan);
    ...
    private void initView(){
        recyclerViewOrderShipper = findViewById(R.id.recycle_order_shipper_admin);
    ...
    public void getListUsers() {
        Call<OrderModel> call = apiShopLapTop.getDonDaXacNhan();
        call.enqueue(new Callback<OrderModel>() {
            ...
            public void onResponse(Call<OrderModel> call, Response<OrderModel> response) {
                ...
                if (orderModel.isSuccess()) {
                    ...
                    orderAdapter = new OrderAdapterShipper(orderList,DonDaXacNhanActivity.this);
