...
import com.appbanlaptop.adapter.shipper.OrderAdapterShipperDaHuy;
...
public class DonDaHuyActivity extends AppCompatActivity {
    ...
    OrderAdapterShipperDaHuy orderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_don_da_huy);
    ...
    private void initView(){
        recyclerViewOrderShipper = findViewById(R.id.recycle_order_shipper_da_huy);
    ...
    public void getListUsers() {
        Call<OrderModel> call = apiShopLapTop.getDonDaHuyCuaShipper(Utils.user_id);
        call.enqueue(new Callback<OrderModel>() {
            ...
            public void onResponse(Call<OrderModel> call, Response<OrderModel> response) {
                ...
                if (orderModel.isSuccess()) {
                    ...
                    orderAdapter = new OrderAdapterShipperDaHuy(orderList,DonDaHuyActivity.this);
