...
import com.appbanlaptop.activity.shipper.ShipperMenuActivity;
...
public class ShipperFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Intent intent = new Intent(getActivity(), ShipperMenuActivity.class);
        startActivity(intent);
//        getActivity().finish();
        return inflater.inflate(R.layout.activity_menu_shipper, container, false);
    }
}