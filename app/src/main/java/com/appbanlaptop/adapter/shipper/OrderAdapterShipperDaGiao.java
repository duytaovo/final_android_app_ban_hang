...
public class OrderAdapterShipperDaGiao extends RecyclerView.Adapter<OrderAdapterShipperDaGiao.ViewHolder>{

    List<OrderHistory> arrayOrder;
    ApiShopLapTop apiShopLapTop;
    private AppCompatActivity mActivity;
    public OrderAdapterShipperDaGiao(List<OrderHistory> arrayOrder, AppCompatActivity activity) { this.arrayOrder = arrayOrder;  mActivity = activity;}
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener, View.OnLongClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            btXemOrder = itemView.findViewById(R.id.btXemOrderShipperDaGiao);
            nameReceive = itemView.findViewById(R.id.etOrderNameReceiveShipperDaGiao);
            addressReceive = itemView.findViewById(R.id.etOrderAddressReceiveShipperDaGiao);
            nameProduct = itemView.findViewById(R.id.etOrderNameProductReceiveShipperDaGiao);
...
//            itemClickListener.onItemClick();
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order_shipper_da_giao, parent,false);
